...
const Banner = () => {
    return (
        <div style={{backgroundImage: `url("https://miraclestudio.design/html/deliciousa-html/assets/images/bg/food-menu-bg2.jpg")`, height: '100vh', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center'}} className='container mx-auto   relative mt-5 rounded-xl'>
            ...
            <img className=' absolute animate-pulse' src="https://miraclestudio.design/html/deliciousa-html/assets/images/logo/banner-logo3.png" alt="" />
            <img className='animate-bounce absolute right-0 ' src="	https://miraclestudio.design/html/deliciousa-html/assets/images/element/element1.png" alt="" />
