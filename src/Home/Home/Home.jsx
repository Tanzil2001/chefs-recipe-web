    ...
    return (
        <div className='container mx-auto'>
            ...
            <div>
                ...
                <div style={{ backgroundImage: `url("https://gico.io/spcica/images/main-slider/1.jpg")`, backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundSize: "cover" }} className=' bg-gradient-to-r from-indigo-200 via-purple-500 to-pink-500 rounded-xl md:grid md:grid-cols-3 gap-5 md:p-5'>
